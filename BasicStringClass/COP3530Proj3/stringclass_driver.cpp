...
Due Time: 11:59PM
Total Points: 25
Assignment 3: String Class Program (Module 5)

Description:
This program is to experiment with strings, palindrome checkers, and testing
the ability to write overload operators using chaining.
*********************************************************************************************/
int main()
{
	string_class s;
